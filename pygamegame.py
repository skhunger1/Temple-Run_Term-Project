...
class PygameGame(object):
    ...
    def __init__(self, width=954, height=720, fps=50, title="112 Pygame Game"):
        self.width = width
        self.height = height
        self.fps = fps
        self.title = title
        ...
        self.bg = pygame.image.load('images/base.jpg')
        self.screen = pygame.display.set_mode((self.width, self.height))
        #self.cloud = pygame.image.load('images/fogLarge.jpg')
        pygame.init()
